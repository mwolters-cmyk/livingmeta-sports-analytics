...
const CATEGORY_DESCRIPTIONS: Record<string, string> = {
  ...
  journal: "Academic journals monitored via RSS for same-day discovery of new issues.",
};

const CATEGORY_ORDER = [
  "blog", "newsletter", "corporate_blog", "journal", "data_platform",
...
export const metadata = {
  ...
  description: "Directory of sports analytics blogs, newsletters, journals, and other sources monitored by the platform.",
};
